...
[`coding-standards.instructions.md`](coding-standards.instructions.md). Test
comments should explain non-obvious fixture or assertion intent rather than
repeat what the test code already expresses.
